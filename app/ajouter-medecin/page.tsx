        ...
        <header className="sticky top-0 z-30 border-b border-gray-800 bg-gray-900/80 backdrop-blur-sm">
          <div className="flex h-16 items-center justify-between px-8">
            <div className="flex items-center gap-4">
              <h2 className="text-xl font-semibold text-gray-100">Ajouter Médecin</h2>
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="h-10 w-64 rounded-lg border border-gray-700 bg-gray-800 pl-10 pr-4 text-sm text-gray-100 placeholder:text-gray-500 focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
                />
              </div>
              <Button
                variant="ghost"
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="h-11 w-full rounded-lg border border-gray-700 bg-gray-900 px-4 text-sm text-gray-100 placeholder:text-gray-500 transition-colors focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
                      required
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    autoComplete="tel"
                    className={`h-11 w-full rounded-lg border bg-gray-900 px-4 text-sm text-gray-100 placeholder:text-gray-500 transition-colors focus:outline-none focus:ring-1 ${
                      fieldErrors.telephone
                ...
                {/* Spécialité */}
                <div className="space-y-2">
                  <label htmlFor="specialite" className="block text-sm font-medium text-gray-300">
                    Spécialité
                  </label>
                  <select
                    id="specialite"
                    ...
                    onChange={handleInputChange}
                    className="h-11 w-full rounded-lg border border-gray-700 bg-gray-900 px-4 text-sm text-gray-100 transition-colors focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500 [color-scheme:dark]"
                    required
                  >
                ...
                <div className="pt-2">
                  <Button
                    ...
                    className="h-12 w-full bg-teal-600 text-base font-semibold text-white transition-all hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {isSubmitting ? (
